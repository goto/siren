...
func RegisterSirenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SirenServiceServer) error {
	...
	mux.Handle("GET", pattern_SirenService_ListSubscriptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/gotocompany.siren.v1.SirenService/ListSubscriptions", runtime.WithHTTPPathPattern("/v1/subscriptions"))
		if err != nil {
...
func RegisterSirenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SirenServiceClient) error {
	...
	mux.Handle("GET", pattern_SirenService_ListSubscriptions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/gotocompany.siren.v1.SirenService/ListSubscriptions", runtime.WithHTTPPathPattern("/v1/subscriptions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SirenService_ListSubscriptions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "subscriptions"}, ""))
)
