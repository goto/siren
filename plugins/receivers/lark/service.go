...
func (s *PluginService) PreHookDBTransformConfigs(ctx context.Context, configurations map[string]any) (map[string]any, error) {
	larkCredentialConfig := &LarkCredentialConfig{}
	...
	creds, err := s.client.ExchangeAuth(ctx, larkCredentialConfig.AuthCode, larkCredentialConfig.ClientID, larkCredentialConfig.ClientSecret)
	if err != nil {
